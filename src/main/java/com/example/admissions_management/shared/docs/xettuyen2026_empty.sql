...
--
-- Table structure for table `xt_nguyenvongxetuyen`
--

DROP TABLE IF EXISTS `xt_nguyenvongxetuyen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `xt_nguyenvongxetuyen` (
  `idnv` int NOT NULL AUTO_INCREMENT,
  `nn_cccd` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `manganh` varchar(20) DEFAULT NULL,
  `matohop` varchar(10) DEFAULT NULL,
  `nv_tt` int DEFAULT '1' COMMENT 'Thu tu nguyen vong 1,2,3...',
  `diem_thxt` decimal(6,2) DEFAULT '0.00' COMMENT 'Diem thi xet tuyen',
  `diem_utqd` decimal(6,2) DEFAULT '0.00' COMMENT 'Diem uu tien quy doi',
  `diem_cong` decimal(6,2) DEFAULT '0.00' COMMENT 'Diem cong',
  `diem_xettuyen` decimal(6,2) DEFAULT '0.00' COMMENT 'Tong diem = thi + utqd + cong',
  `nv_ketqua` varchar(45) DEFAULT 'Dang xet' COMMENT 'Dau, Truot, Dang xet',
  `tt_phuongthuc` varchar(45) DEFAULT NULL,
  `nv_keys` varchar(100) NOT NULL COMMENT 'Khoa tro: cccd_manganh_matohop_tt',
...
--
-- Dumping data for table `xt_nguyenvongxetuyen`
--

LOCK TABLES `xt_nguyenvongxetuyen` WRITE;
/*!40000 ALTER TABLE `xt_nguyenvongxetuyen` DISABLE KEYS */;
/*!40000 ALTER TABLE `xt_nguyenvongxetuyen` ENABLE KEYS */;
UNLOCK TABLES;
