...
public class AdminConsole extends JFrame {
    ...
    public AdminConsole(
        ...
        candidateTableModel = new DefaultTableModel(
                new Object[]{"ID", "CCCD", "SBD", "Họ", "Tên", "Ngày Sinh", "Điện Thoại", "Giới Tính", "Email", "Nơi Sinh", "Đối Tượng", "Khu Vực"}, 0
        ) {
            @Override
            public boolean isCellEditable(int row, int column) {
                return false;
    ...
    private void loadCandidates() {
        ...
        List<XtThiSinhXetTuyen25Entity> candidates =
                candidateController.searchCandidates(candidateQuery, candidatePage);
