...
public class NguyenVongXetTuyenService {
    ...
    public List<NguyenVongXetTuyen> getResultByMaNganh(String maNganh) {
        return nguyenVongRepository.findByMaNganhOrderByDiemXetTuyenDesc(maNganh);
    }
    ...
    public NguyenVongXetTuyen calculateScore(Integer nvId, BigDecimal diemThxt, BigDecimal diemUtqd) {
        ...
        // Lấy điểm cộng
        BigDecimal diemCong = getDiemCongForNguyenVong(nv.getNnCccd(), nv.getMaNganh(), nv.getMaToHop());
    ...
    public Map<String, Object> performSelectionForMajor(String maNganh) {
        ...
        List<NguyenVongXetTuyen> nguyenVongs = nguyenVongRepository.findByMaNganhOrderByDiemXetTuyenDesc(maNganh);
    ...
    public List<NguyenVongXetTuyen> getPassedApplicants(String maNganh) {
        return nguyenVongRepository.findByMaNganh(maNganh).stream()
